<?php
		...
		class Rig_Add_To_Cart extends Widget_Base {


			public function get_name() {
				return 'rig-add-to-cart';
			}


			public function get_title() {
				return __( 'Add To Cart', 'rig-elements' );
			}
			...
			protected function register_controls() {
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
							'{{WRAPPER}} .cart' => 'text-align: {{options}};',
						],
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'size_units' => [ 'px', 'em' ],
                        'selectors' => [
                            '{{WRAPPER}} .cart button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_control(
                    'button_transition',
                    [
                        'label' => __( 'Transition Duration', 'rig-elements' ),
                ...
                $this->start_controls_section(
                    ...
                    [
                        'label' => __( 'Quantity', 'rig-elements' ),
                        'tab' => Controls_Manager::TAB_STYLE,
                    ]
                );
                ...
                $this->start_controls_section(
                    ...
                    [
                        'label' => __( 'Variations', 'rig-elements' ),
                        'tab' => Controls_Manager::TAB_STYLE,
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        'label' => __( 'Select field', 'rig-elements' ),
                        'type' => Controls_Manager::HEADING,
                        'separator' => 'before',
                    ]
                );
			...
			protected function render() {
				$product_add_to_cart = (new Rig_Query_Control())->get_product_add_to_cart();

				if ($product_add_to_cart == null) {
					$preview_add_to_cart = (new Rig_Query_Control())->get_product_preview();
